...
<div style="display:flex;flex-wrap:wrap;gap:0.5rem;margin-top:1rem;">
  ...
  <a href="https://scholar.google.com.au/citations?user=GeNHmf4AAAAJ&hl=en" target="_blank" style="display:inline-flex;align-items:center;gap:0.4rem;padding:0.32rem 0.85rem;border:1.5px solid #ddd;border-radius:6px;font-size:0.8rem;color:#555;text-decoration:none;transition:all 0.15s;" onmouseover="this.style.borderColor='#c0392b';this.style.color='#c0392b'" onmouseout="this.style.borderColor='#ddd';this.style.color='#555'">
  ...
  <a href="https://github.com/Linwei94" target="_blank" style="display:inline-flex;align-items:center;gap:0.4rem;padding:0.32rem 0.85rem;border:1.5px solid #ddd;border-radius:6px;font-size:0.8rem;color:#555;text-decoration:none;transition:all 0.15s;" onmouseover="this.style.borderColor='#c0392b';this.style.color='#c0392b'" onmouseout="this.style.borderColor='#ddd';this.style.color='#555'">
  ...
  <a href="/assets/CV.pdf" target="_blank" style="display:inline-flex;align-items:center;gap:0.4rem;padding:0.32rem 0.85rem;border:1.5px solid #ddd;border-radius:6px;font-size:0.8rem;color:#555;text-decoration:none;transition:all 0.15s;" onmouseover="this.style.borderColor='#c0392b';this.style.color='#c0392b'" onmouseout="this.style.borderColor='#ddd';this.style.color='#555'">
